                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(
                                    text:
                                        'Looking for an experienced and reliable cleaner to perform a deep cleaning for a 2-bedroom apartment (approx. 1,000 sq. ft).                              Work includes:\n',
                                    style: TextStyle(
                                      color: const Color(0xFF071727),
                                      fontSize: 13.96,
                                      fontFamily: 'Inter',
                                  ...
                                  TextSpan(
                                    text:
                                        'Cleaning materials can be provided if required.                              Preference will be given to workers with prior residential cleaning experience and good reviews.',
                                    style: TextStyle(
                                      color: const Color(0xFF071727),
                                      fontSize: 13.96,
                                      fontFamily: 'Inter',
        ...
        Stack(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(color: const Color(0xFF142356), width: 2),
                boxShadow: const [
                  BoxShadow(
