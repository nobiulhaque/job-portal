...
class EditworkerProfileView extends GetView<EditworkerProfileController> {
  EditworkerProfileView({super.key});
  @override
  final controller = Get.put(EditworkerProfileController());
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() => controller.skills.isNotEmpty
                        ? Wrap(
                            spacing: 8,
                            runSpacing: 8,
