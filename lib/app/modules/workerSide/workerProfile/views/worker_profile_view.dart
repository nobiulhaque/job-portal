...
import '../../../profile/help/views/help_view.dart';
import '../../../profile/privacy/views/privacy_view.dart';
import '../../EditworkerProfile/views/editworker_profile_view.dart';
import '../../review/views/review_with_profile.dart';
import '../../workerPayment/views/worker_payment_view.dart';
            ...
            children: [
              ...
              _buildCard(
                child: _buildMenuItem(
                  ...
                  onTap: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context)=> EditworkerProfileView()));
                  },
                ),
              ),
              const SizedBox(height: 24),
                ...
                child: Column(
                  children: [
                    _buildMenuItem(
                      ...
                      title: 'Payments',
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> WorkerPaymentView()));
                      },
                    ),
                    const SizedBox(height: 24),
                    _buildMenuItem(
                    ...
                    _buildMenuItem(
                      ...
                      title: 'Review',
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> ReviewWithProfileProfileView()));
                      },
                    ),
                    const SizedBox(height: 24),
                    _buildMenuItem(
